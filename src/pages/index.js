   ...
   return (
      <div className="intro">
         <h2 className="intro__title">
            Hi. My name is Danny. <br />
            I'm a web developer
         </h2>
         <p className="intro__blurb">
            I design and develop experiences on the internet.
            <br />
            I'm currently a <strong>Senior Frontend Developer</strong> at{' '}
            <a href="https://www.convertus.com">Convertus</a>.
         </p>
         <p className="intro__disclaimer">
            My new portfolio isn't quite ready. For now, please check out my{' '}
            <a href="http://www.dannyburton.ca">old one</a>.
         </p>
         <svg
            className="logo"
